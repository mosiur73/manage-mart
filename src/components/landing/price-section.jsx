    ...
    >
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="mx-auto grid max-w-6xl gap-8 py-16 lg:grid-cols-3">
          {/* Starter Plan */}
          <Card className="relative flex flex-col justify-between p-6 rounded-2xl shadow-md hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 bg-white border border-gray-200">
            <CardHeader>
          ...
          {/* Pro Plan (Featured) */}
          <Card className="relative flex flex-col justify-between p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-2 border-primary bg-gradient-to-b from-primary/5 to-white">
